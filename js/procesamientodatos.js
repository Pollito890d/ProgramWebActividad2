const form = document.getElementById('registroForm');
        ...
        form.addEventListener('submit', (e) => {
            ...
            // Si todos los campos son válidos, calculamos y mostramos el modal
            if (esValido) {
                const edad = calcularEdad(fecha);
                const cuentaRegresiva = tiempoParaCumpleanos(fecha);
                txtEdad.textContent = `Tienes ${edad} años de edad cumplidos.`;
                // Si la función devuelve directamente un string:
